  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        coral: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-coral-glow hover:shadow-lg",
        sage: "bg-primary-light text-primary hover:bg-primary-light/80 border border-primary/20",
        soft: "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground",
        glass: "bg-card/60 backdrop-blur-lg border border-border/50 hover:bg-card/80 hover:border-border",
      },
      size: {
